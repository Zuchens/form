...
//
//    private Binding<Data, String> passwordBinding;
//    private Binding<Data, String> confirmPasswordBinding;
//
...
//                                fullNameField))
//                .bind(Data::getFullName, Data::setFullName);
//
...
//                        status -> commonStatusChangeHandler(status,
//                                phoneOrEmailField))
//                .bind(Data::getEmailOrPhone, Data::setEmailOrPhone);
//
...
//                        status -> commonStatusChangeHandler(status,
//                                passwordField))
//                .bind(Data::getPassword, Data::setPassword);
...
//                .bind(Data::getPassword, (data, pwd) -> {
//                });
//
...
//                            data.getFullName(), data.getEmailOrPhone()),
//                    Type.HUMANIZED_MESSAGE);
//            String json = gson.toJson(data);
//
//            try {
//                FileWriter writer = new FileWriter("person_"+ data.getId()+"_"+ data.getDate()+".json");
//                writer.write(json);
//                writer.close();
//
//            } catch (IOException e) {
